      ...
      <Grid item>
        <List>
          <Collapse in={checked}>
            ...
            <Todo
              complete
              text="Refactor note model for different categories"
            />
            ...
            <Todo
              complete
              subtodo
              text='Set up "Is this a Project? Yes" flow'
            />
            <Todo
              complete
              subtodo
          ...
          <Todo
            subtodo
            text="create an informative and engaging landing page"
          />
          ...
          <Todo text="Refactor with Django or Golang" />
        </List>
      </Grid>
    </Grid>
  );
